...
export const ICE_GAMES: IceGame[] = [
  {
    ...
    howTo: [
      ...
      "돌아가며 제시어를 한 문장씩 설명합니다. 너무 뻔하면 라이어가 알아챕니다.",
      "라이어라고 생각하는 사람에게 투표합니다.",
 ...
 * 라이어 게임의 주제와 제시어.
 *
 * 기획안에 없어 임시로 채웠다 — 대학생 팀이 설명하기 쉬운 것들로.
 * 한 판에 주제 하나, 그 안에서 제시어 하나를 서버가 무작위로 고른다.
 */
export const LIAR_TOPICS: { topic: string; words: string[] }[] = [
  { topic: "음식", words: ["떡볶이", "김치찌개", "마라탕", "초밥", "삼겹살", "짜장면", "비빔밥", "치킨", "라면", "파스타"] },
  { topic: "캠퍼스", words: ["도서관", "학생식당", "강의실", "동아리방", "기숙사", "운동장", "편의점", "과방", "주차장", "정문"] },
  { topic: "동물", words: ["고양이", "강아지", "펭귄", "기린", "판다", "코끼리", "햄스터", "돌고래", "거북이", "사자"] },
  { topic: "직업", words: ["소방관", "요리사", "의사", "선생님", "유튜버", "경찰", "기자", "바리스타", "파일럿", "디자이너"] },
  { topic: "장소", words: ["놀이공원", "영화관", "바다", "공항", "찜질방", "노래방", "병원", "캠핑장", "PC방", "지하철역"] },
  { topic: "물건", words: ["우산", "노트북", "칫솔", "이어폰", "거울", "지갑", "냉장고", "안경", "텀블러", "보조배터리"] },
];
