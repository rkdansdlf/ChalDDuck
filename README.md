...
넓은 화면에서도 앱은 390px 기기 프레임 안에서 돕니다. 33번(채팅 PC 3분할)은 1024px 이상에서
어떻게 보여야 하는지의 **디자인 기준 페이지**로 `/preview/chat-desktop` 에 따로 있고,
사용자 경로에는 링크하지 않습니다. 앱 셸을 반응형으로 바꾸는 것은 아직 남은 일입니다.
